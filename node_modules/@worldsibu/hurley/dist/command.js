...
var tasks = {
    createNetwork: function (network, organizations, users, channels, path, inside, skipDownload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, cli_1.CLI.createNetwork(network, organizations, users, channels, path, inside, skipDownload)];
    ...
    installChaincode: function (chaincode, language, orgs, channel, version, params, path, ccPath, colConfig, inside, debug) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, cli_1.CLI.installChaincode(chaincode, language, orgs, channel, version, params, path, ccPath, colConfig, inside, debug)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    },
    upgradeChaincode: function (chaincode, language, orgs, channel, version, params, path, ccPath, colConfig, inside) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, cli_1.CLI.upgradeChaincode(chaincode, language, orgs, channel, version, params, path, ccPath, colConfig, inside)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    invokeChaincode: function (chaincode, fn, channel, path, user, organization, inside, transientData) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, cli_1.CLI.invokeChaincode.apply(cli_1.CLI, tslib_1.__spread([chaincode, fn, channel, path, user, organization,
...
program
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!cmd) return [3, 2];
                return [4, tasks.createNetwork(cmd.network, !cmd.organizations || (cmd.organizations <= 2) ? 2 : cmd.organizations, !cmd.users || (cmd.users <= 1) ? 1 : cmd.users, !cmd.channels || (cmd.channels <= 1) ? 1 : cmd.channels, cmd.path, !!cmd.inside, !!cmd.skipDownload)];
            case 1:
                _a.sent();
                return [3, 4];
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4, Promise.all(cmd.channel.map(function (channel) {
                        return tasks.installChaincode(name, language, cmd.org, channel, '1.0', cmd.ctor, cmd.path, cmd.chaincodePath, cmd.collectionsConfig, !!cmd.inside, !!cmd.debug);
                    }))];
            case 1:
                _a.sent();
                return [2];
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                cmd.channel = (!cmd.channel || cmd.channel.length === 0) ? ['ch1'] : cmd.channel;
                return [4, Promise.all(cmd.channel.map(function (channel) {
                        return tasks.upgradeChaincode(name, language, cmd.org, channel, ver, cmd.ctor, cmd.path, cmd.chaincodePath, cmd.collectionsConfig || '', !!cmd.inside);
                    }))];
            case 1:
                _a.sent();
                return [2];
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, tasks.invokeChaincode.apply(tasks, tslib_1.__spread([chaincode,
                        fn,
                        cmd.channel,
                        cmd.path,
                        cmd.user || 'user1',
