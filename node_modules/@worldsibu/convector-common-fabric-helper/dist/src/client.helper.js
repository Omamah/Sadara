...
var ClientHelper = (function () {
    ...
    ClientHelper.prototype.init = function (initKeyStore) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            var stateStore, cryptoSuite, cryptoStore, mspPath, e_1, _a, _b, _c, _d, networkProfilePath, profileStr, e_2, organizations;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        cryptoStore = Client.newCryptoKeyStore({
                            path: this.renderVariables(this.config.keyStore)
                        });
                        cryptoSuite.setCryptoKeyStore(cryptoStore);
                        this.client.setCryptoSuite(cryptoSuite);
                        mspPath = path_1.resolve(process.cwd(), this.renderVariables(this.config.userMspPath));
                        _e.label = 4;
                    case 4:
                        _e.trys.push([4, 6, , 7]);
                    ...
                    case 11:
                        ...
                        networkProfilePath = this.renderVariables(this.config.networkProfile);
                        _e.label = 12;
                    case 12:
                        _e.trys.push([12, 14, , 15]);
                        return [4, fs_extra_1.readFile(path_1.resolve(process.cwd(), networkProfilePath), 'utf8')];
                    case 13:
                        profileStr = _e.sent();
                    ...
                    case 14:
                        e_2 = _e.sent();
                        throw new Error("Failed to read or parse the network profile at '" + networkProfilePath + "', " + e_2.toString());
                    case 15:
    ...
    ClientHelper.prototype.close = function () {
        console.log('Cleaning up event hubs');
        this.hubsInUse
            .filter(function (hub) { return hub.isconnected(); })
            .map(function (hub) { return hub.disconnect(); });
        this.hubsInUse = [];
    };
    ...
    ClientHelper.prototype.renderVariables = function (data) {
        if (data === void 0) { data = ''; }
        return data.replace(/(\$[a-z_0-9]+)/ig, function (variable) { return process.env[variable.slice(1)] || variable; });
    };
    return ClientHelper;
}());
